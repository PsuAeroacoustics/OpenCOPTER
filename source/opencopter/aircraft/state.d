...
extern (C++) struct BladeStateT(ArrayContainer AC) {
	...
	this(size_t num_chunks, ref BladeGeometryT!AC blade, double radius, double direction) {
		...
		writeln("circulation model defined");
...
extern (C++) struct WingStateT(ArrayContainer AC) {
	...
	this(size_t num_wing_parts, size_t span_elements, size_t chordwise_nodes, ref WingGeometryT!AC wing, InflowT!AC _inflow_model) {
		...
		writeln("wing part state defined");
	}
	...
	ref typeof(this) opAssign(typeof(this) wing) {
		...
		this.inflow_model = wing.inflow_model;
		this.C_L = wing.C_L;
		return this;
	}
...
extern (C++) struct WingPartStateT(ArrayContainer AC) {
	...
	this(size_t span_elements,size_t chord_ctrl_pt, ref WingPartGeometryT!AC wing_part) {
		...
		writeln("Circulation model for the wing initialized");
		foreach(ref chunk; chunks) {
			chunk.dC_L[] = 0;
			//chunk.dC_T[] = 0;
			//chunk.dC_D[] = 0;
